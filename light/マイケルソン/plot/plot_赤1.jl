...
df1 = CSV.read("マイケルソン/data/赤1.csv", DataFrame) #light/ まで入れなきゃいけない時がある． 
...
CSV.write("マイケルソン/output_data/D_赤1.csv", result_D) #light/ まで入れなきゃいけない時がある．
