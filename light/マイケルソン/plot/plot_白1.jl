...
df1 = CSV.read("マイケルソン/data/白1.csv", DataFrame) #light/ まで入れなきゃいけない時がある． 
...
CSV.write("light/マイケルソン/output_data/予測光路差_白1.csv", result) =#
CSV.write("マイケルソン/output_data/D_白1.csv", result_D) #light/ まで入れなきゃいけない時がある．
